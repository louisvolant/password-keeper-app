...
<Button
  ...
  className="w-full mt-4 bg-blue-50 dark:bg-blue-900 text-blue-800 dark:text-blue-100 border border-blue-300 dark:border-blue-700 hover:bg-blue-100 dark:hover:bg-blue-800 flex items-center justify-center gap-2 transition-colors duration-200"
>
