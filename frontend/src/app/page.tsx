...
export default function Home() {
  ...
  const handleFeatureClick = (mode: "login" | "register") => {
    if (!isAuthenticated) {
      setModalMode(mode);
      setIsModalOpen(true);
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <header className="flex justify-between items-center mb-16">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Password Keeper</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
          ...
          <Link
            href="/securecontent"
            onClick={(e) => {
              if (!handleFeatureClick("login")) e.preventDefault();
            }}
